...
class FinancePresenter(finRep: FinanceRepository, expRepository: FinancesLocalRepository) : FinanceContract.Presenter {
    var view: FinanceContract.View? = null
    var finRep: FinanceRepository? = finRep
    var expRepository : FinancesLocalRepository = expRepository
